...
class DealViewModel extends GetxController  {
  ...
  Future<void> fetchData() async {
    ...
    try {
      final response = await _apiService.fetchData(_perPage, _page, "id,created_at,created_at_in_millis,image_medium,comments_count,store{name}");
      _page++;
